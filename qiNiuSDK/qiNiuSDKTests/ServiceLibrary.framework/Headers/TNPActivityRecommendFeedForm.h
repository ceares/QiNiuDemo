//
//  TNPActivityRecommendFeedForm.h
//  ServiceLibrary
//
...
@interface TNPActivityRecommendFeedForm : NSObject

//关系表主键  类型:Long
@property (nonatomic,copy) NSString * relationId;

//feed改造对应activityId，规则：a_activityId 类型String
@property (nonatomic,copy) NSString * fromFeedId;

//feed改造对应被推荐activityId，规则：a_activityId 类型String
